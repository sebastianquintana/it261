...
while($row = mysqli_fetch_assoc($result)){
         ...
         echo '<li class="bold">Click here for more information <a href="custumer-view.php?id='.$row['AlfajorID'].'">'.$row['AlfajorName'].'</a> </li>';
         echo '<li>'.$row['price'].'</li>';
         echo '<li>'.$row['DateSeason'].'</li>';
         echo '</ul>';
}//end of while
} else {
